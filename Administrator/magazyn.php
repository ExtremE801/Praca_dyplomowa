...
<html lang="pl">
  ...
  <main>
    <section>
      <h1>Witamy w Magazynie</h1>
      <p>Strona stworzona w celu obslugi magazynu</p>
    </section>

    <section>
      <h2>Nasze usługi</h2>
      <ul >
        <li class="Tab_list">Magazynowanie i zarządzanie zapasami</li>
        <li class="Tab_list">Dodawanie przedmiotów</li>
        <li class="Tab_list">Wydawanie produktów</li>
        <li class="Tab_list">Znalezienie produktu na magazynie</li>
